...
class SupervisedPolicy(object):
	...
	def __init__(self, learning_rate = 0.001):
		...
		with tf.compat.v1.variable_scope('supervised_policy'):
			...
			self.loss = tf.reduce_sum(-tf.compat.v1.log(self.picked_action_prob)) + sum(tf.compat.v1.get_collection(tf.compat.v1.GraphKeys.REGULARIZATION_LOSSES, scope = 'supervised_policy'))
